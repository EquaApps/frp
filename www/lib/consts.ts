...
export const WindowsInstallCommand = <T extends Client | Server>(
  ...
  `Invoke-WebRequest https://raw.githubusercontent.com/johncoker233/frpaaa/main/install.ps1 `+
...
export const LinuxInstallCommand = <T extends Client | Server>(
  ...
  return `curl -sSL https://raw.githubusercontent.com/johncoker233/frpaaa/main/install.sh | bash -s --${ExecCommandStr(type, item, info, ' ')}`
}
